...
def test_create_palette_from_dict_sets_qt_group():
    ...
    color_inactive = palette.color(
        QtGui.QPalette.ColorGroup.Inactive, QtGui.QPalette.ColorRole.WindowText
    )
...
def test_get_rect_from_points_given_topleft_bottomright():
    rect = utils.get_rect_from_points(QtCore.QPointF(-10, -20), QtCore.QPointF(30, 40))
...
@pytest.mark.parametrize(
    "number,base,expected", [(33, 5, 35), (-33, 5, -35), (50, 5, 50), (3.1, 0.5, 3.0)]
)
...
@pytest.mark.parametrize(
    "rgba,expected", [((255, 0, 0, 255), "#ff0000"), ((255, 0, 0, 100), "#ff000064")]
)
